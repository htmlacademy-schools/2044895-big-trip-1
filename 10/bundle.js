  ...
  constructor(routePointContainer, changeData, changeMode) {
    ...
    _classPrivateFieldInitSpec(this, _setListeners, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _editFormComponent).setEditSubmitHandeler(() => {
          this.replaceEditFormToPoint();
          document.removeEventListener('keydown', onEscKeyDown);
        });
...
class TripPresenter {
  constructor(tripContainer) {
    ...
    _classPrivateFieldInitSpec(this, _renderRoutePoints, {
      writable: true,
      value: () => {
        if (_classPrivateFieldGet(this, _routePoints).length === 0) {//this.#renderListEmptyMessage();
          //return;
        }
...
class EditForm extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get template() {
    return createEditForm(_classPrivateFieldGet(this, _routePoint));
  }
...
/* harmony import */ var _presenter_trip_presenter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./presenter/trip-presenter */ "./src/presenter/trip-presenter.js");
...
const tripPresentor = new _presenter_trip_presenter__WEBPACK_IMPORTED_MODULE_10__["default"](siteEvents);
tripPresentor.init();
})();
