...
var _editSubmitHandler = /*#__PURE__*/new WeakMap();

var _editClickHandler = /*#__PURE__*/new WeakMap();

class EditForm extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(routePoint) {
    ...
    _defineProperty(this, "setEditSubmitHandeler", callback => {
      this._callback.editSubmit = callback;
      this.element.querySelector('.event__rollup-btn').addEventListener('submit', _classPrivateFieldGet(this, _editSubmitHandler));
    });
    ...
    _classPrivateFieldInitSpec(this, _editSubmitHandler, {
      writable: true,
      value: evt => {
        evt.preventDefault();
...
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.renderElement)(siteEvents, new _view_sort__WEBPACK_IMPORTED_MODULE_4__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.renderPosition.BEFOREEND);
const routePointList = new _view_route_point_lists__WEBPACK_IMPORTED_MODULE_5__["default"]();
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.renderElement)(siteEvents, routePointList, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.renderPosition.BEFOREEND);
...
function renderRoutePoint(routePointListElement, routePoint) {
  ...
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.renderElement)(routePointListElement, routePointComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.renderPosition.BEFOREEND);
}
...
if (routePoints.length === 0) {
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.renderElement)(routePointList, new _view_list_empty__WEBPACK_IMPORTED_MODULE_9__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.renderPosition.BEFOREEND);
}
})();
